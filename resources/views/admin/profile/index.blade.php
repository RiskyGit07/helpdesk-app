...
<div class="tab-content">
        ...
        <div class="card mb-5 mb-xl-10">
            <div class="card-header cursor-pointer">
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Detail Profil Admin</h3>
                </div>
            </div>
            <div class="card-body p-9">
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">
                            {{ Auth::user()->birth_date ? date('d/m/Y', strtotime(Auth::user()->birth_date)) : '-' }}
                        </span>
                    </div>
                </div>
    ...
    <div class="tab-pane fade" id="kt_tab_settings">
        <div class="card mb-5 mb-xl-10">
            <div class="card-header cursor-pointer">
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Pengaturan Akun</h3>
                </div>
            </div>
            <div class="card-body p-9">
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i>
                    Klik tombol <strong>Edit Profil</strong> di atas untuk mengubah data profil Anda.
                </div>
            </div>
        </div>
    </div>
