...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Edit Profil User</h3>
    </div>
    <div class="card-body">
        @if(session('success'))
        ...
        <form method="POST" action="{{ route('user.profile.update') }}">
            ...
            <div class="row mb-6">
                ...
                @if(in_array(Auth::user()->user_type, ['pegawai_asn', 'pegawai_non_asn']))
                    <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <a href="{{ route('user.profile') }}" class="btn btn-light">Batal</a>
                </div>
            </div>
        </form>
    </div>
